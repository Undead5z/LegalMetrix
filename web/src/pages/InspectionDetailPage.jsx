...
export function InspectionDetailPage() {
  ...
  const choosingFinding = ['POTENTIAL_NON_COMPLIANCE_CONFIRMED', 'ESCALATED_FOR_ENFORCEMENT_REVIEW'].includes(pendingDecision);
  const presentationStatus = inspection.admin_decision === 'ESCALATED_FOR_ENFORCEMENT_REVIEW' ? 'ESCALATED_FOR_ENFORCEMENT_REVIEW' : inspection.admin_decision === 'POTENTIAL_NON_COMPLIANCE_CONFIRMED' ? 'POTENTIAL_NON_COMPLIANCE_CONFIRMED' : inspection.state;
