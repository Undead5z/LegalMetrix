...
export function InspectionDetailPage() {
  ...
  const productCondition = inspection.product_condition || 'UNKNOWN';
  const productConditionReason = inspection.product_condition_reason || 'Product condition could not be reliably determined from the available date evidence.';
  ...
  return <>
    ...
    <section className="panel product-condition-panel"><div className="section-title"><div><span className="eyebrow">INFORMATIONAL</span><h3>Product condition</h3><p>Separate from the label-compliance determination.</p></div><span>{productCondition.replaceAll('_', ' ')}</span></div><p>{productConditionReason}</p></section>
