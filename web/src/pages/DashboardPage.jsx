...
export function DashboardPage() {
  ...
  return <>
    <section className="page-heading">
      <div><span className="eyebrow gold-label">LIVE DATABASE VIEW</span><h2>Command centre</h2><p>Inspection activity, potential issues, and review status from the LegalMetrix repository.</p></div>
