...
ensureColumn('inspection_images', 'quality_override', 'INTEGER NOT NULL DEFAULT 0');
ensureColumn('inspection_images', 'quality_override_by', 'TEXT');
ensureColumn('inspection_images', 'quality_override_at', 'TEXT');
...
ensureColumn('inspections', 'product_condition', "TEXT NOT NULL DEFAULT 'UNKNOWN'");
ensureColumn('inspections', 'product_condition_reason', 'TEXT');
ensureColumn('inspections', 'product_condition_evaluated_at', 'TEXT');
